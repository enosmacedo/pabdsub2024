...
if __name__ == '__main__':
    ...
    class Interface:
        ...
        def janela_login(self):
            ...
            self.larg_login = self.login.winfo_reqheight()
            self.aut_login = self.login.winfo_reqwidth()
            self.larg_tela = self.login.winfo_screenwidth()
            self.alt_tela = self.login.winfo_screenheight()
            self.pos_x = (self.larg_tela // 2) - (self.larg_login // 2)
            self.pos_y = (self.alt_tela // 2) - (self.aut_login // 2)
            self.login.geometry(f"{self.larg_login}x{self.aut_login}+{self.larg_tela//2}+{self.alt_tela//2}")
